...
<form method="post" action="StudentServlet">
    ...
    <table border=1 width=500 cellpadding=1 cellspacing=1 bgcolor="#EBF1F4">
	    ...
	    <tr>
            <th colspan="2" bgcolor="#BADFF8">Fill the form Student</th>
        </tr>
        <tr>
        ...
        <tr>
            <td width="10%">Name:</td>
            <td width="10%"><input type="text" name="name" size="60"/></td>
        </tr>
        <tr>
            <td width="10%">Surname:</td>
            <td width="10%"><input type="text" name="surname" size="60"/></td>
        </tr>
