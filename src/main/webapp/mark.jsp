...
<div align="center" style="padding: 5px;">
   ...
   <form method="post" action="StudentServlet">
    ...
    <table border=1 width=500 cellpadding=1 cellspacing=1 bgcolor="#EBF1F4">
        ...
        <tr>
            <td width="10%">Mark:</td>
            <td width="10%"><input type="text" name="mark" size="60"/></td>
        </tr>
        <tr>
            <td width="10%">Student ID:</td>
            <td width="10%"><input type="text" name="studentId" size="60"/></td>
        </tr>
		
		<tr>
            <td width="10%">Subject ID:</td>
            <td width="10%"><input type="text" name="subjectId" size="60"/></td>
        </tr>
